...
/**
 * CakeS3 component acts as an interface between CakePHPsetup controllers
...
echo '<pre>';print_r($contents);die;
    ...
    /**
     * Fetch files from given folder in bucket
     * 
     * @param string $bucket_name Name of the bucket
     * @param $folder $bucket_name Name of the folder 
     * @return Array
     */
    public function list_s3_bucket($folder,$bucket_name=null)
    {
        if(null==$bucket_name)
