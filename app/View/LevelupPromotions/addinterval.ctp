...
<?php 
    ...
    ?>
    <form accept-charset="utf-8" method="post" id="LevelupSettingsForm" class="form-horizontal" action="/LevelupPromotions/addinterval">
        <h4 class="header blue bolder smaller">General</h4>
        <div class="form-group">
            <label for="form-field-1" class="col-sm-3 control-label no-padding-right"><span class="star">*</span>Interval Plan Name</label>
            <div class="col-sm-9">
        ...
        <h4 class="header blue bolder smaller">Phase Settings</h4>


        <input type="hidden" id="phase_cnt" id="phase_cnt" value="1">
        <input type="hidden" readonly="readonly"
               value="0" name="total_visits" id="total_visits" placeholder="Total Visits" class="col-xs-10 col-sm-5" maxlength="5">
        <input type="hidden" readonly="readonly" value="0" name="total_points" id="total_points" placeholder="Total Points" class="col-xs-10 col-sm-5" maxlength="100">

        <div id="phase_div">
            <div class="form-group" id="phase_1">
                <label for="form-field-1" class="col-sm-3 control-label no-padding-right" id="phase_name_1" style=" padding-top: 26px;"></label>
                <div class="col-sm-9">
