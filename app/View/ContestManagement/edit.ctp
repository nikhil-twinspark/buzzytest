...
function fileBrowserCallBack(field_name, url, type, win) {
	...
	<?php echo $this->Form->create("Contest",array('enctype'=>'multipart/form-data','class'=>'form-horizontal'));
       ...
       <div class="form-group Clearfix">
            ...
            <?php echo $this->Form->input("contest_name",array('label'=>false,'div'=>false,'class'=>'editable','value'=>$this->request->data['Contest']['contest_name'],'placeholder'=>'Contest Name','required','maxlength'=>'36')); ?>
        ...
        <div class="form-group Clearfix">
            ...
            <div class="col-sm-9 col-xs-12">
                <?php echo $this->Form->textarea('contest_description', array('class' => 'ckeditor','value'=>$this->request->data['Contest']['contest_description']));?>
            </div>
        </div>
    ...
    <div class="form-group Clearfix">
        <div id="ermsgstafflogo" class="message" style="color: red;margin-left:270px;"></div>
            ...
            <div class="col-sm-9 col-xs-12">
                <?php if(isset($this->request->data['Contest']['contest_image'])){ ?>
                    <img src="<?=$this->request->data['Contest']['contest_image']?>" height="200" width="500">
                <?php  }
                    echo $this->Form->input("contest_image",array('type' => 'file','label'=>false,'div'=>false,'accept'=>'image/*','class'=>'hand-icon',"onchange"=>"checkimg('ContestContestImage','ci');"));
                ?>
       ...
       if(isset($this->request->data['Contest']['contest_area'])){ $challenge_area=$this->request->data['Contest']['contest_area']; }else{ $challenge_area=''; }
		...
		<div class="col-sm-9 col-xs-12">	
                    <?php echo $this->Form->textarea('contest_area', array('class' => 'ckeditor','value'=>$challenge_area));?>
                </div>
       </div>
