    ...
    ?>
     ...
     <div class="adminsuper">
            <span style='float:right;' class="add_rewards" >
                <a href="<?php echo $this->Html->url(array("controller"=>"LitePromotionManagement","action"=>"addpromotion"));?>" class="icon-add info-tooltip">Add Lite Promotion</a>
            </span>
       ...
       <thead>
        ...
        <tr> 
         ...
         <td width="15%" class="managementbtn"><a href="<?php echo $this->Html->url(array(
							    "controller" => "LitePromotionManagement",
