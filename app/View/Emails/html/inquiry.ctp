                    ...
                    <table class="table600" width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td align="left" colspan="2" style="font-family: 'Open Sans', Arial, sans-serif; font-size:18px;">
                                <single label="title"><p>Hi BuzzyDoc ,</p><p>A new enquiry has been received from <strong><?=$redeem_data['enquiry_name']?></strong>.Please find the details below:</p></single>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="left" colspan="2" style="font-family: 'Open Sans', Arial, sans-serif; font-size:18px;">
                                <single label="title"><b>Name:</b><?=$redeem_data['enquiry_name']?></single>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2" style="font-family: 'Open Sans', Arial, sans-serif; font-size:18px;">
                                <single label="title"><b>Email:</b><?=$redeem_data['enquiry_email']?></single>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2" style="font-family: 'Open Sans', Arial, sans-serif; font-size:18px;">
                                <single label="title"><b>Subject:</b><?=$redeem_data['enquiry_subject']?></single>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2" style="font-family: 'Open Sans', Arial, sans-serif; font-size:18px;">
                                <single label="title"><b>Message:</b><?=$redeem_data['enquiry_msg']?></single>
                            </td>
                        </tr>

                        <tr>
                            <td style="font-family: 'Open Sans', Arial, sans-serif; font-size:18px;">
                                <p>&nbsp;</p>
                                <p>Thanks,</p>
                                <p>The BuzzyDoc Team</p>
                            </td>
                        </tr>
                        <!-- end title -->
                        <tr>
