...
echo $this->Form->input('action', array('type' => 'hidden','value'=>'update'));
    if($promotion['Promotion']['default']==1){
        $red1='disabled="disabled"';
    }else{
        $red1='';
    }
 ?>
...
<option value="1" <?php if($promotion['Promotion']['default']==1){ echo "selected"; } ?>>Network Promotions</option>
<option value="0" <?php if($promotion['Promotion']['default']==0){ echo "selected"; } ?>>Custom Promotions</option>
</select>
</div>
 </div>
        <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <input type="text"  maxlength="100" class="col-xs-10 col-sm-5" placeholder="Description" id="description" name="description" value="<?php echo $promotion['Promotion']['description']; ?>"  <?=$red1?>>
    ...
    <input type="text"  maxlength="7" class="col-xs-10 col-sm-5" placeholder="Value" id="value" name="value" value="<?php echo $promotion['Promotion']['value']; ?>">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <select id="operand" class="col-xs-10 col-sm-5 valid" name="operand"  <?=$red1?>>
