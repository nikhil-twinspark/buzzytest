...
$sessionstaff = $this->Session->read('admin');  ?>
...
<?php 
    ...
    ?>
<form action="/GlobalUserManagement/updateuserprofile" method="POST" name="myinfo_form" class="form-horizontal" id="myinfo_form">

    <input type="hidden" value="<?=$Users['User']['id']?>" name="id" id="id">
    <input type="hidden" value="<?=$clinic_id?>" name="clinic_id" id="clinic_id">
    <input type="hidden" value="<?=$card_number?>" name="card_number" id="card_number">

    <div class="form-group Clearfix">
        <label class="col-sm-3 col-xs-12 control-label no-padding-right" ><span class="star">*</span>Card Number:</label>
        <div class="col-sm-9 col-xs-12">
            <input type="text" placeholder="Amount" type="text"  name="first_name" value="<?=$card_number?>" size="24" maxlength="50" readonly>
        </div>
    </div>
...
?>
    ...
    <div class="form-group Clearfix"  id="email_field">
        <label class="col-sm-3 col-xs-12 control-label no-padding-right">
            Username:</label>
        <div class="col-sm-9 col-xs-12">
            <input 	class="col-xs-12 col-sm-5" type="text" name="aemail" value="<?=$email?>" maxlength="50" id='aemail'>
        </div>
    </div>
									<?php
    ...
    <div class="form-group Clearfix">
        ...
        <div class="col-sm-9 col-xs-12">
            <input type="text" placeholder="First Name" id="first_name" name="first_name" value="<?=$first_name?>" size="24" maxlength="20" >
        </div>
    </div>
          <?php 
    ...
    <div class="form-group Clearfix">
        ...
        <div class="col-sm-9 col-xs-12">
         ...
         foreach($profile_field as $field){ 
    ...
    <div class="form-group Clearfix">
        <label class="col-sm-3 col-xs-12 control-label no-padding-right"><?php echo $field_val;  ?>:</label>
        <div class="col-sm-9 col-xs-12">
            <select class="form-control select-info patientinfo_sel" name="<?php echo $field['ProfileField']['profile_field']; ?>[]" id="<?php echo $field['ProfileField']['profile_field']; ?>"  multiple="multiple" size="4">
    ...
    <div class="form-group Clearfix">
        <label class="col-sm-3 col-xs-12 control-label no-padding-right" ><?php echo $field_val;  ?>:</label>
        <div class="col-sm-9 col-xs-12">
            <select class="form-control select-info" name="<?php echo $field['ProfileField']['profile_field']; ?>" id="<?php echo $field['ProfileField']['profile_field']; ?>" >
                <option value="">Please Select</option>
                                                    <?php foreach($field_options_red as $op){ ?>
    ...
    <div class="form-group Clearfix">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <div id="othertext_<?php echo str_replace(array('?','#'),'',$field['ProfileField']['profile_field']); ?>"  class="othertextbox">
                ...
                <input type="text" name="other_<?php echo $field['ProfileField']['profile_field']; ?>" id="other_<?php echo $field['ProfileField']['profile_field']; ?>" placeholder="Other" value="<?=$othervalrd?>" maxlength="30" class="col-xs-10 col-sm-5">     
            ...
            <script>
                ...
                function opt1(val, val1, val2) {
                    ...
                    if (val == 'other') {
                        $('#othertext_' + val1).html('<input type="text" name="other_' + val1 + '" id="other_' + val1 + '" placeholder="Other" value="' + val2 + '" maxlength="30" class="col-xs-10 col-sm-5">');
                    } else {
     ...
     <div class="form-group" style="overflow:hidden;">
        ...
        <div class="col-sm-9">
            ...
            <div id="othertext_<?php echo str_replace(array('?','#'),'',$field['ProfileField']['profile_field']); ?>" class="col-xs-10 col-sm-5">
