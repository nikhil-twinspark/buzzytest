         ...
         <?php
			if (!empty($sessionpatient['preferences']['customer_fields_order'])) {
             ...
             <?php if (!empty($sessionpatient['customer_info']['customer'][0]['first_name'])) {
								...
								?>
	<input	class="form-control" type="text" name="first_name" value="<?=$first_name?>" maxlength="255" id='first_name' onkeypress="changeErrorMessage(this.id)">
				</div>
              <?php }
             ...
             <?php
								...
								?>
<input 	class="form-control" type="text" name="last_name" value="<?=$last_name?>" maxlength="255" id="last_name" onkeypress="changeErrorMessage(this.id)" >
				</div>
            <?php }elseif ($field_sorted == 'phone') { ?>
              <div class="form-group">
               <label >Phone:</label><span style='color:red;font-style:italic;padding-left:50px;' id="error_div_msg_phone" ></span>
								...
								?>
<input 	class="form-control"  type="text" id='phone' name="phone" value="<?=$phone?>" maxlength="10" onkeyup="this.value=this.value.replace(/\D/g,'')" onkeypress="changeErrorMessage(this.id)">
				</div>
               ...
               <label>Email <span style="color:red;">*</span><span style='color:red;font-style:italic;padding-left:50px;' id="error_div_msg_email" ></span></label>
								...
								?>
<input 	class="form-control" type="email" name="email" value="<?=$email?>" maxlength="255" id='email' onkeypress="changeErrorMessage(this.id)">
				</div>
               ...
               <label>Date Of Birth <span style="color:red;">*</span><span style='color:red;font-style:italic;padding-left:50px;' id="error_div_msg_date_year" ></span></label>
				...
				<select name="date_year" size="1" class="form-control" id='date_year' onchange="changeErrorMessage(this.id)">
				...
				<select name="date_month" size="1"  class="form-control" id='date_month' onchange="changeErrorMessage(this.id)">
				...
				<select name="date_day" size="1" class="form-control" id='date_day' onchange="changeErrorMessage(this.id)">
...
<?php } ?>
               ...
               <label>Zip:</label>
									...
									?>
									<input 	class="form-control" type="text" name="postal_code" value="<?=$postal_code?>" maxlength="255">
...
<script type="text/javascript">
    ...
    function redeemPointsConfirmation(){
            ...
            var email = $("#email").val();
            if($("#first_name").val()==''){
                $("#first_name").css('background-color','#FF9966');
                $("#error_div_msg_first_name").html("First name cannot be blank");
                $("#first_name").focus();

            }else if($("#last_name").val()==''){
                $("#last_name").css('background-color','#FF9966');
                $("#error_div_msg_last_name").html("Last name cannot be blank");
                $("#last_name").focus();
            
            }else if($("#email").val()==''){
                 $("#email").css('background-color','#FF9966');
                 $("#error_div_msg_email").html("Email cannot be blank");
                 $("#email").focus();

            }else if( !regex.test(email)){
                $("#email").css('background-color','#FF9966');
                $("#error_div_msg_email").html("Invalid email address. Please enter a valid email address.");
                $("#email").focus();

            }else if($("#date_year").val()==''){
                $("#date_year").css('background-color','#FF9966');
                $("#error_div_msg_date_year").html("Please select a valid year to proceed");

            }else if($("#date_month").val()==''){
                $("#date_month").css('background-color','#FF9966');
                $("#error_div_msg_date_year").html("Please select a valid month to proceed");

            }else if($("#date_day").val()==''){
                $("#date_day").css('background-color','#FF9966');
                $("#error_div_msg_date_year").html("Please select a valid day to proceed");

            }else if(($("#phone").val()!='') && ($("#phone").val().length < 10)){
                $("#phone").css('background-color','#FF9966');
                $("#error_div_msg_phone").html("Please enter a valid phone number");
                $("#phone").focus();
