...
$sessionpatient = $this->Session->read('patient');?>
      <div class="mobilebanner m-bot-5"> 
       ...
       <?php echo $this->element('left_sidebar'); ?>
        ...
        <!--<div class="banner"> 
        <?php echo $this->html->image(CDN.'img/reward_imges/banner.png',array('width'=>'730','height'=>'250', 'class' => 'img-responsive'));?>
          </div>-->
          <div class="loginArea ">
            <div class="contBox ln_height">
            <?php if(count($Documents) > 0){ ?>
                <P class='doc_heading'>Document Downloads</P>
            <?php }else{ ?>
