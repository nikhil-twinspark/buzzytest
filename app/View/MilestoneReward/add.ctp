...
<div class="col-sm-9">
    ...
    <input type="text"  maxlength="50" class="col-xs-10 col-sm-5" placeholder="Name" id="name" name="name" value="">
</div>
 </div>
      <div class="form-group">
...
<div class="col-sm-9">
    ...
    <input type="text"  maxlength="255" class="col-xs-10 col-sm-5" placeholder="Description" id="description" name="description" value="">
</div>
 </div>
       <div class="form-group">
...
<div class="col-sm-9">
    ...
    <input type="text"  maxlength="7" class="col-xs-10 col-sm-5" placeholder="Point" id="points" name="points" value="" onkeyup="getearning();">
</div>
 </div>
      <div style="color:red;font-size: 12px;margin-bottom: 10px;margin-left: 270px;" id="showmsg"></div>
...
$(document).ready(function() { 
        ...
        $('#MilestoneRewardAddForm').validate({
		rules: {
                        name: "required",
                        coupon_id: "required",
