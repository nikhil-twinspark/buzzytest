...
Profile Fields
    ...
    ?>
     ...
     <form accept-charset="utf-8" method="post" id="ProfileFieldAddForm" class="form-horizontal" action="/ProfileFieldManagement/edit/<?php echo $ProfileFields['ProfileField']['id']; ?>">
        ...
        <div class="form-group Clearfix">
            ...
            <div class="col-sm-9 col-xs-12">
               <?php $name=ucwords(str_replace('_',' ',$ProfileFields['ProfileField']['profile_field'])); ?>
                <input type="text" id="ProfileFieldProfileField" maxlength="255" class="col-xs-10 col-sm-5" placeholder="Description" required="required" name="data[ProfileField][profile_field]" value="<?php echo $name; ?>">
       ...
       <div class="form-group Clearfix" id="options">
        ...
        <?php }else{ ?><label class="col-sm-3 col-xs-12 control-label no-padding-right blank_lab" for="form-field-1">&nbsp;</label><?php } ?>
            ...
            <div class="col-sm-9 col-xs-12 pull-right <?=$new?>">
                <input type="text" id="Option<?php echo $i; ?>" maxlength="20" class="col-xs-10 col-sm-5" placeholder="Option" required="required" name="data[ProfileField][options][]" value="<?php echo $option; ?>">
        <?php if($i>2){ ?>
...
<span class="star">*</span>Field Options</label><div class="col-sm-9 col-xs-12"><input type="text" id="Option1" maxlength="20" class="col-xs-10 col-sm-5" placeholder="Option" required="required" name="data[ProfileField][options][]"><div class="add_profile icon-1" onclick="addoptionmore();">Add</div></div><div id="field2" class="input_option"><label  class="col-sm-3 control-label no-padding-right blank_lab" for="form-field-1">&nbsp;</label><div class="col-sm-9 col-xs-12 pull-right"><input type="text" id="Option2" maxlength="20" class="col-xs-10 col-sm-5" placeholder="Option" required="required" name="data[ProfileField][options][]"></div></div>'); 
                    ...
                    $('#optionval').html('<input type="hidden" id="cnt" name="cnt" value="2"><div id="field1" class="input_option"><label  class="col-sm-3 control-label no-padding-right" for="form-field-1"><span class="star">*</span>Field Options<label class="col-sm-10 control-label no-padding-right"><input type="checkbox" id="other" name="other">Other</label></label><div class="col-sm-9 col-xs-12"><input type="text" id="Option1" maxlength="20" class="col-xs-10 col-sm-5" placeholder="Option" required="required" name="data[ProfileField][options][]"><div class="add_profile icon-1" onclick="addoptionmore();">Add</div></div><div id="field2" class="input_option"><label  class="col-sm-3 control-label no-padding-right blank_lab" for="form-field-1">&nbsp;</label><div class="col-sm-9 col-xs-12 pull-right"><input type="text" id="Option2" maxlength="20" class="col-xs-10 col-sm-5" placeholder="Option" required="required" name="data[ProfileField][options][]"></div></div>');
                }
