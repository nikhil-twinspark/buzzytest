...
return array(
    ...
    'net\\authorize\\api\\contract\\v1\\CreateFingerPrintRequest' => $vendorDir . '/authorizenet/authorizenet/lib/net/authorize/api/contract/v1/CreateFingerPrintRequest.php',
    'net\\authorize\\api\\contract\\v1\\CreateFingerPrintResponse' => $vendorDir . '/authorizenet/authorizenet/lib/net/authorize/api/contract/v1/CreateFingerPrintResponse.php',
    ...
    'net\\authorize\\api\\contract\\v1\\FingerPrintSupportInformationType' => $vendorDir . '/authorizenet/authorizenet/lib/net/authorize/api/contract/v1/FingerPrintSupportInformationType.php',
    ...
    'net\\authorize\\api\\contract\\v1\\SearchCriteriaCustomerProfileType' => $vendorDir . '/authorizenet/authorizenet/lib/net/authorize/api/contract/v1/SearchCriteriaCustomerProfileType.php',
    ...
    'net\\authorize\\api\\controller\\CreateFingerPrintController' => $vendorDir . '/authorizenet/authorizenet/lib/net/authorize/api/controller/CreateFingerPrintController.php',
